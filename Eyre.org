...
#+BEGIN_SRC snippet :tangle ~/.eyre/snippets/clojure-mode/go :mkdirp true
# name: timeout
# key: timeout
# --
(go (<! (timeout $1))
...
#+BEGIN_SRC snippet :tangle ~/.eyre/snippets/clojure-mode/reg-event-fx :mkdirp true
# name: reg-event-fx
# key: fx
# --
...
#+BEGIN_SRC snippet :tangle ~/.eyre/snippets/clojure-mode/reg-event-db :mkdirp true
# name: reg-event-db
# key: db
# --
